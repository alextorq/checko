...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Frontend_Copyright__ = __webpack_require__(622);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  beforeRouteUpdate: function beforeRouteUpdate(to, from, next) {
    ...
    axios.post('/frontend/pages/' + to.params.page).then(function (responce) {
      _this.info = responce.data;
      setTimeout(function () {
        var top = document.querySelector('.default-content');
